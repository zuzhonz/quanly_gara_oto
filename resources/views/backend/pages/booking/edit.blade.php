        ...
        <div class="row page-titles mx-0">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form class="p-5" action=" {{ route('route_BE_Admin_Update_Booking') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('email') ?? (request()->email ?? $res->email) }}" type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('phone') ?? (request()->phone ?? $res->phone) }}" type="text"
                                        name="phone" class="form-control" id="" aria-describedby="emailHelp">
                                    {{-- hiển thị lỗi validate -  funciton message trong file DanhMucRequest --}}
                                    @error('phone')
                                        <span style="color: red"> {{ $message }} </span>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('birthday') ?? (request()->birthday ?? $res->birthday) }}"
                                        type="date" name="birthday" class="form-control" id=""
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="address">{{ $res->address }}</textarea>
                                    {{-- <div class="card">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="booking_time_id" id="">
                                        ...
                                        @foreach ($booking_time as $item)
                                            @if ($item->id == $res->booking_time_id)
