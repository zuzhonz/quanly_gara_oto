                    ...
                    <form action="" class="my-4">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <a href="{{ route('route_BE_Admin_Add_Cars') }}" class="btn btn-secondary"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($list as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            @foreach ($car_branch as $r)
                                                @if ($r->id == $item->car_branch_id)
                                                    {{ $r->name }}
                                                @endif
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            @if ($item->car_hot)
                                                    <a href="{{ route('route_BE_Admin_updateCarHot', $item->id) }}" class="label label-table label-success" style="border: none" >Hot</a>
                                                @else
                                                    <a href="{{ route('route_BE_Admin_updateCarHot', $item->id) }}" class="label label-table label-danger" style="border: none">Không Hot</a>
                                                @endif
                                        </td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Edit_Cars', ['id' => $item->id]) }}" class="btn btn-warning">Edit</a>
                                        </td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Delete_Cars', ['id' => $item->id]) }}" class="btn btn-danger">Delete</a>
                                        </td>
