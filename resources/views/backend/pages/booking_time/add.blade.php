        ...
        <div class="row page-titles mx-0">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form class="p-5" action=" {{ route('route_BE_Admin_Add_Booking_Time') }}" method="post" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('start_time') ?? request()->start_time }}" type="time" name="start_time"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('end_time') ?? request()->end_time }}" type="time" name="end_time"
                                        class="form-control" id="" aria-describedby="emailHelp">
                                    {{-- hiển thị lỗi validate -  funciton message trong file DanhMucRequest --}}
                                    @error('end_time')
                                        <span style="color: red"> {{ $message }} </span>
