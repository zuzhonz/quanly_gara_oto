                    ...
                    <form action="" class="my-4">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <a href="{{ route('route_BE_Admin_Add_Employees') }}" class="btn btn-secondary"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($list as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->address }}</td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Edit_Employees', ['id' => $item->id]) }}" class="btn btn-warning">Edit</a>
                                        </td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Delete_Employees', ['id' => $item->id]) }}" class="btn btn-danger">Delete</a>
                                        </td>
