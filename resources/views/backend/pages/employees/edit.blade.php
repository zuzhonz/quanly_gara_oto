        ...
        <div class="row page-titles mx-0">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form class="p-5" action=" {{ route('route_BE_Admin_Update_Employees') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('email') ?? (request()->email ?? $res->email) }}" type="text" name="email"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('phone') ?? (request()->phone ?? $res->phone) }}" type="text" name="phone"
                                        class="form-control" id="" aria-describedby="emailHelp">
                                    {{-- hiển thị lỗi validate -  funciton message trong file DanhMucRequest --}}
                                    @error('phone')
                                        <span style="color: red"> {{ $message }} </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('CCCD') ?? (request()->CCCD ?? $res->CCCD) }}" type="text" name="CCCD"
                                        class="form-control" id="" aria-describedby="emailHelp">
                                    {{-- hiển thị lỗi validate -  funciton message trong file DanhMucRequest --}}
                                    @error('CCCD')
                                        <span style="color: red"> {{ $message }} </span>
                            ...
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('birthday') ?? (request()->birthday ?? $res->birthday) }}" type="date" name="birthday"
                                        class="form-control" id="" aria-describedby="emailHelp">
                                    {{-- hiển thị lỗi validate -  funciton message trong file DanhMucRequest --}}
                                    @error('birthday')
                                        <span style="color: red"> {{ $message }} </span>
