                    ...
                    <form action="" class="my-4">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <a href="{{ route('route_BE_Admin_Add_Booking_Time') }}" class="btn btn-secondary"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($list as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->end_time }}</td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Edit_Booking_Time', ['id' => $item->id]) }}" class="btn btn-warning">Edit</a>
                                        </td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Delete_Booking_Times', ['id' => $item->id]) }}" class="btn btn-danger">Delete</a>
                                        </td>
