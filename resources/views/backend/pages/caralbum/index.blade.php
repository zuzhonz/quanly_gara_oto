                    ...
                    <form action="" class="my-4">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <a href="{{ route('route_BE_Admin_Add_Car_Album') }}" class="btn btn-secondary"><i
                            ...
                            <tbody>
                                @foreach ($list as $key => $item)
                                    <tr>
                                        ...
                                        <td><img src="/storage/{{$item->image}}" width="50px" height="50px"></td>
                                        <td class="col-1">
                                            <a href="{{ route('route_BE_Admin_Edit_Car_Album', ['id' => $item->id]) }}" class="btn btn-warning">Edit</a>
                                        </td>
                                        <td class="col-1">
                                            <a href=" {{ route('route_BE_Admin_Delete_Car_Album', ['id' => $item->id]) }}" class="btn btn-danger">Delete</a>
                                        </td> 
                                    </tr>
                                @endforeach
                            </tbody>
